package com.example.youfit.Activities.AllPosture;
...
import com.example.youfit.Activities.ASANA.Pranayaam;
import com.example.youfit.Activities.ASANA.chakraasana;
import com.example.youfit.Activities.ASANA.paschimottanansna;
import com.example.youfit.Activities.ASANA.trikonasana;
import com.example.youfit.Activities.ASANA.virabhadraasana;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        vajraasana.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getContext(), com.example.youfit.Activities.ASANA.vajraasana.class);
        ...
        shavasana.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getContext(), com.example.youfit.Activities.ASANA.shavasana.class);
                startActivity(intent);
            }
        });
        gomukhasana.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getContext(), com.example.youfit.Activities.ASANA.gomukhasana.class);
                startActivity(intent);
            }
        });
        vrikshaasana.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getContext(), com.example.youfit.Activities.ASANA.vrikshaasana.class);
                startActivity(intent);
            }
        });
        paschimottaasana.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getContext(), paschimottanansna.class);
                startActivity(intent);
            }
        });
        ...
        charkasana.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getContext(), com.example.youfit.Activities.ASANA.hastuttanasana.class);
                startActivity(intent);
            }
        });
        ...
        tadasana.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getContext(), com.example.youfit.Activities.ASANA.tadasana.class);
                startActivity(intent);
            }
        });
        bhujangasana.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getContext(), com.example.youfit.Activities.ASANA.bhujangasana.class);
                startActivity(intent);
            }
        });
