package com.example.youfit.Activities;
...
//            Log.d("sumblue", " sumblue"+sumblue);
            ...
            if (totaltime >= 30) {
                ...
                double HRfreq = com.example.youfit.Math.Fft.FFT(red, counter, SamplingFreq);
...
//                Log.d("var", "varr "+varr+" varb"+varb+" R"+R);
            ...
            if (o2 != 0) {
                Intent i = new Intent(Oxygenprocess.this, oxygencalculator.class);
                i.putExtra("o2r", o2);
                startActivity(i);
                finish();
            }
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(Oxygenprocess.this, MainActivity.class);
