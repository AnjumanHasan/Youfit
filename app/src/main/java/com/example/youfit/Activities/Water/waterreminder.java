package com.example.youfit.Activities.Water;
...
public class waterreminder extends AppCompatActivity {
    ...
    TextView waterprogress,hydrationleveltext;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hydrationleveltext= findViewById(R.id.hydrationlevel);
//        Date currentTime = Calendar.getInstance().getTime();
        loaddata();
        changehydrationlevel();
...
//        if(currentTime.equals("00 00 00 00 00 00"));
    ...
    void changehydrationlevel(){
        hydrationleveltext.setText("Hydration Level : "+ progress+"%");
    }
    @Override
